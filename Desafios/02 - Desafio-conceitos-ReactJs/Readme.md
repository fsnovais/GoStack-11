...
**Resposta:** 
As tecnologias utilizadas neste projeto são [NodeJS](https://nodejs.org/en/), [Yarn](https://yarnpkg.com/), [Axios](https://www.npmjs.com/package/axios), [React](https://pt-br.reactjs.org/),[jest](https://jestjs.io/),[User-event](https://github.com/testing-library/user-event).
